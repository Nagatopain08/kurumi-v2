...
class Command extends BaseCommand_1.default {
    constructor(client, handler) {
        ...
        this.run = (M, { joined }) => __awaiter(this, void 0, void 0, function* () {
            if (!joined)
                return void (yield M.reply(`Provide the text, Baka!`));
            const cara = joined.trim();
            const wall = yield w5botapi.textpro("https://textpro.me/create-a-futuristic-technology-neon-light-text-effect-1006.html", cara);
