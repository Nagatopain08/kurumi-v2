...
class Command extends BaseCommand_1.default {
    constructor(client, handler) {
        ...
        this.run = (M) => __awaiter(this, void 0, void 0, function* () {
            ...
            const h = yield sHentai.getRandom();
            // fetch result of https://waifu.pics/api/sfw/waifu from the API using axios
            //const { data } = await axios.get('https://api-xcoders.xyz/api/anime/randomnhentai?apikey=Zl0clXuAbx')
            const buffer = yield request_1.default.buffer(h.cover).catch((e) => {
                return void M.reply(e.message);
            });
            while (true) {
                try {
                    M.reply(buffer || 'Could not fetch image. Please try again later', baileys_1.MessageType.image, undefined, undefined, `*Name*: ${h.titles.english}\n*Code*: ${h.id}\n`, undefined).catch((e) => {
