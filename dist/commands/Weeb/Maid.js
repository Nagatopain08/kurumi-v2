...
class Command extends BaseCommand_1.default {
    constructor(client, handler) {
        ...
        this.run = (M) => __awaiter(this, void 0, void 0, function* () {
            ...
            const wall = yield akaneko_1.default.nsfw.maid();
            ...
            while (true) {
                try {
                    M.reply(buffer || "Could not fetch image. Please try again later", baileys_1.MessageType.image, undefined, undefined, `*Master...*\n`, undefined).catch((e) => {
