...
class Command extends BaseCommand_1.default {
    constructor(client, handler) {
        ...
        this.run = (M) => __awaiter(this, void 0, void 0, function* () {
            ...
            const { data } = yield axios_1.default.get('https://waifu.pics/api/sfw/neko');
            const buffer = yield request_1.default.buffer(data.url).catch((e) => {
                return void M.reply(e.message);
            });
            while (true) {
                try {
                    M.reply(buffer || 'Could not fetch image. Please try again later', baileys_1.MessageType.image, undefined, undefined, `*Nyaa...*\n`, undefined).catch((e) => {
