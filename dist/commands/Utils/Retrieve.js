    ...
    constructor(client, handler) {
        ...
        this.run = (M) => __awaiter(this, void 0, void 0, function* () {
            ...
            return void M.reply(yield this.client.downloadMediaMessage(((_j = M.quoted.message) === null || _j === void 0 ? void 0 : _j.message)
                .viewOnceMessage), baileys_1.MessageType[((_m = (_l = ((_k = M.quoted.message) === null || _k === void 0 ? void 0 : _k.message).viewOnceMessage) === null || _l === void 0 ? void 0 : _l.message) === null || _m === void 0 ? void 0 : _m.imageMessage)
                ? "image"
                : "video"], undefined, undefined, "🌟 Here you go.");
        });
    }
}
