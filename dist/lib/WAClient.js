...
class WAClient extends baileys_1.WAConnection {
    constructor(config) {
        ...
        this.saveAuthInfo = (ID) => __awaiter(this, void 0, void 0, function* () {
            const session = yield this.DB.session.findOne({ ID });
            if (!session)
                return void (yield new this.DB.session({
                    ID,
        ...
        this.simplifyMessage = (M) => __awaiter(this, void 0, void 0, function* () {
            ...
            const sender = {
                ...
                isAdmin: groupMetadata && groupMetadata.admins
            ...
            const content = type === baileys_1.MessageType.text && ((_b = M.message) === null || _b === void 0 ? void 0 : _b.conversation)
                ...
                : this.supportedMediaMessages.includes(type)
                    ? this.supportedMediaMessages
                        .map((type) => {
                        var _a, _b;
                        return (_b = (_a = M.message) === null || _a === void 0 ? void 0 : _a[type]) === null || _b === void 0 ? void 0 : _b.caption;
                    })
                        .filter((caption) => caption)[0] || ""
                    : type === baileys_1.MessageType.extendedText &&
                        ((_d = (_c = M.message) === null || _c === void 0 ? void 0 : _c.extendedTextMessage) === null || _d === void 0 ? void 0 : _d.text)
            ...
            quoted.message = ((_h = (_g = (_f = M === null || M === void 0 ? void 0 : M.message) === null || _f === void 0 ? void 0 : _f[type]) === null || _g === void 0 ? void 0 : _g.contextInfo) === null || _h === void 0 ? void 0 : _h.quotedMessage)
                ...
                : null;
            quoted.sender =
                ((_m = (_l = (_k = M.message) === null || _k === void 0 ? void 0 : _k[type]) === null || _l === void 0 ? void 0 : _l.contextInfo) === null || _m === void 0 ? void 0 : _m.participant) ||
                    null;
            return {
                type,
                content,
        ...
        this.log = (text, error) => {
            console.log(chalk_1.default[error ? "red" : "green"]("[CHITOGE]"), chalk_1.default.blue((0, moment_1.default)(Date.now() * 1000).format("DD/MM HH:mm:ss")), chalk_1.default.yellowBright(text));
        };
        ...
        this.getGroupData = (jid) => __awaiter(this, void 0, void 0, function* () {
            return (yield this.DB.group.findOne({ jid })) ||
                (yield new this.DB.group({ jid }).save());
        });
        this.getFeatures = (feature) => __awaiter(this, void 0, void 0, function* () {
            return (yield this.DB.feature.findOne({ feature })) ||
                (yield new this.DB.feature({ feature }).save());
        });
