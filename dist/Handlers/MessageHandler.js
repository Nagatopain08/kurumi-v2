...
const WAConnection_1 = require("@adiwajshing/baileys/lib/WAConnection");
    ...
    constructor(client) {
        ...
        this.handleMessage = (M) => __awaiter(this, void 0, void 0, function* () {
            ...
            if (!M.groupMetadata && !(M.chat === "dm"))
                return void null;
            if ((yield this.client.getGroupData(M.from)).mod &&
                ((_b = (_a = M.groupMetadata) === null || _a === void 0 ? void 0 : _a.admins) === null || _b === void 0 ? void 0 : _b.includes(this.client.user.jid)))
                this.moderate(M);
            ...
            if (!(allowedCommands.includes(cmd) ||
                (yield this.client.getGroupData(M.from)).cmd))
            ...
            if (!command)
                return void M.reply(yield request_1.default.buffer(`https://telegra.ph/file/1e39217e12c4bf9e4e788.jpg`), WAConnection_1.MessageType.image, undefined, undefined, `No such command, Baka! Have you never seen someone use the command *${this.client.config.prefix}help*`, undefined);
            const user = yield this.client.getUser(M.sender.jid);
            if (user.ban)
                return void M.reply("You're Banned from using commands.");
            const state = yield this.client.DB.disabledcommands.findOne({
            ...
            if (((_d = command.config) === null || _d === void 0 ? void 0 : _d.modsOnly) &&
                !((_e = this.client.config.mods) === null || _e === void 0 ? void 0 : _e.includes(M.sender.jid))) {
